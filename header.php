...
$michigan_webnus_options['michigan_webnus_get_layout'] = isset( $michigan_webnus_options['michigan_webnus_get_layout'] ) ? $michigan_webnus_options['michigan_webnus_get_layout'] : '' ;
...
$boxed_layout = ( ( $background_layout == 'boxed-wrap' ) && ( $menu_type != 6 ) && ( $menu_type != 7 ) ) ? $background_layout . ' ' : '';
echo $boxed_layout;
?>">
...
if ( $header_show || is_archive() || is_single() || is_home() || $is_buddy || is_search() ) :
...
$michigan_webnus_options['michigan_webnus_logo_width'] = isset($michigan_webnus_options['michigan_webnus_logo_width'])? $michigan_webnus_options['michigan_webnus_logo_width'] : '';
...
$michigan_webnus_options['michigan_webnus_sticky_logo_width'] = isset($michigan_webnus_options['michigan_webnus_sticky_logo_width']) ? $michigan_webnus_options['michigan_webnus_sticky_logo_width'] : '';
...
// Site Title
if (empty($logo)){
	$michigan_webnus_options['michigan_webnus_slogan'] = isset($michigan_webnus_options['michigan_webnus_slogan']) ? $michigan_webnus_options['michigan_webnus_slogan'] : '';
...
// Button in Header
	...
	if($michigan_webnus_options['michigan_webnus_header_button_enable'] && $menu_type != 11  && $menu_type != 10){?>
...
// Modal Contact Form
$form_id = isset( $michigan_webnus_options['michigan_webnus_topbar_form'] ) ? esc_html($michigan_webnus_options['michigan_webnus_topbar_form']) : '' ;
$michigan_webnus_options['michigan_webnus_color_skin'] = isset($michigan_webnus_options['michigan_webnus_color_skin']) ? $michigan_webnus_options['michigan_webnus_color_skin'] : '' ;

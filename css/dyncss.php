...
$footer_background_image = (isset($thm_options['michigan_webnus_footer_background_image']['url']) && $thm_options['michigan_webnus_footer_background_image']['url'] ) ? $thm_options['michigan_webnus_footer_background_image']['url'] : '';
...
$twitter_background_image = (isset($thm_options['michigan_webnus_footer_twitter_background_image']['url']) && $thm_options['michigan_webnus_footer_twitter_background_image']['url'] ) ? $thm_options['michigan_webnus_footer_twitter_background_image']['url'] : '';
...
if ( $thm_options['michigan_webnus_color_skin'] != 'e3e3e3' || $thm_options['michigan_webnus_custom_color_skin'] ) {
  ...
  $color_custom    = ( isset($thm_options['michigan_webnus_custom_color_skin']) && $thm_options['michigan_webnus_custom_color_skin'] ) ? $thm_options['michigan_webnus_custom_color_skin'] : '' ;
  $color_predefined = ( $thm_options['michigan_webnus_color_skin'] != 'e3e3e3' ) ? $thm_options['michigan_webnus_color_skin'] : '' ;
  $color = ( isset($thm_options['michigan_webnus_custom_color_skin']) && $thm_options['michigan_webnus_custom_color_skin'] ) ? $color_custom : '#'.$color_predefined ;
 ...
 * Custom CSS
*/
$thm_options['michigan_webnus_custom_css'] = (isset($thm_options['michigan_webnus_custom_css']) && $thm_options['michigan_webnus_custom_css']) ? $thm_options['michigan_webnus_custom_css'] : '';

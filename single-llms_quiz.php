	...
	<div class="col-md-6">
		<div class="post-thumbnail quiz-thumbnail">
			<?php if(isset($lesson_features['image']) && $lesson_features['image'] && has_post_thumbnail()){
				...
				$no_image_src = ($michigan_webnus_options['michigan_webnus_course_no_image_src']['url'])?$michigan_webnus_options['michigan_webnus_course_no_image_src']['url']: get_template_directory_uri().'/images/course_no_image.png';
